        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-[2.5rem] overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row min-h-[500px]">
          ...
          <div className="w-full md:w-5/12 bg-white dark:bg-gray-700/30 p-10 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-700">
            ...
            <div className="flex gap-4 w-full justify-center">
              <a
                href="https://github.com/studywithself/coding"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-blue-600 text-white rounded-xl hover:bg-indigo-700 transition-all hover:-translate-y-1 shadow-md hover:shadow-lg"
                aria-label="Coding Study"
              >
                <FaCode size={24} />
              </a>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-[#EB531F] text-white rounded-xl hover:bg-[#d94614] transition-all hover:-translate-y-1 shadow-md hover:shadow-lg"
                aria-label="Tistory"
              >
                <SiTistory size={20} />
              </a>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="group flex items-center gap-6 p-5 rounded-2xl bg-white dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600 hover:border-green-200 dark:hover:border-green-500/30 transition-all shadow-sm hover:shadow-md">
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <a
                    href="tel:010-3940-7145"
                    className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-green-600 dark:hover:text-green-400 transition-colors block truncate"
                  >
                    010-3940-7145
                  </a>
                </div>
